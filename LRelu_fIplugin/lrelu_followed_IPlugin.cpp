...
{
public:
    CopyHalfPlugin(const Weights *weights, int nbWeights, int nbOutputChannels): mNbOutputChannels(nbOutputChannels)
    {
    }
...
private:
    ...
    Dims mInputDims;
    Dims mOutputDims;
    unsigned int mCount = 10 << 20; // 10M work space size in bytes
