...
const char* DEPLOY_FILE = "/home/lynette/work/LReluIplugin_caffe/test.prototxt";
const char* INPUT_BLOB_NAME = "data";
const char* OUTPUT_BLOB_NAME = "relu1";
...
public:
    ...
    virtual int enqueue(int batchSize, const void* const* inputs, void** outputs, void* workspace, cudaStream_t stream) override
    {
        ...
        CHECK(cudaMemcpyAsync(outputs[0], inputs[0], BATCH_SIZE * INPUT_C * INPUT_H * INPUT_W  * sizeof(float) / 4, cudaMemcpyDeviceToDevice, stream));
...
ICudaEngine* buildEngine(const char* deployFile, unsigned int maxBatchSize,
...
int main(int argc, char** argv)
{
    ...
    engine = buildEngine(DEPLOY_FILE, BATCH_SIZE, &pluginFactory);
